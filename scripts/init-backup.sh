...
[Service]
Type=oneshot
ExecStart=/usr/bin/docker run --rm --network wt_mongo -v /mnt/home:/backup -v /home/core/rclone/:/conf wholetale/backup backup.sh 2>&1  > /home/core/wholetale/backup.log
